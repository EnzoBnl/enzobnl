...
### 3.2.1. Build using Maven
Flexible-memoization is available as a GitHub maven package, under the following dependency:
...
Check the [documentation about installing a GitHub maven package](https://help.github.com/en/github/managing-packages-with-github-packages/configuring-apache-maven-for-use-with-github-packages#installing-a-package).
...
<h1><div align="center"><a href="./2.html">&larr;</a> <a href="./4.html">&rarr;</a></div></h1>
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTgyNzUzNDE1OSwtMTM4MDc0Nzc3NCwtMT
M5NTk1NzY2NSwtMTA3MDU1NjUzMl19
-->