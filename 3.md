...
### 3.2.1. Install
*Flexible-memoization* is available as a *GitHub Maven package*. You can use it through the following dependency in your `pom.xml`:
...
<h1><div align="center"><a href="./2.html">&larr;</a> <a href="./4.html">&rarr;</a></div></h1>
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEwMDk4Mjk4NDIsLTEzODA3NDc3NzQsLT
EzOTU5NTc2NjUsLTEwNzA1NTY1MzJdfQ==
-->