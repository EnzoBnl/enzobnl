...
- **readability**: code appearance will be familiar to the rest of the community, as the set of idioms represent a standard.
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTYzNzAzMjExOSwxOTg1MTM1MzEsLTE1Mz
