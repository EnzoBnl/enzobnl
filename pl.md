...
# SQL
## LEFT SEMI JOIN
The result of `A LEFT SEMI JOIN B` is `C` which is a subset of A's records (only A's fields) whose key is also match
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTUwNzY0NzE4NCw5OTkzNDIxMTYsMjExND
