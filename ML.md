...
The MLE principle wants the algorithm to maximize the following quantity called likelihood $\prod_{i=1}^{m} p(y^{(i)}|X^{(i)}$ which is the probability that our 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTIzOTk3NTI2NSwtNDEwMzM4NDM2LDMzOT
